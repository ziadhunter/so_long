...
void print_player(t_data *data, t_img *new_image, int c)
{
    if (data->map->player.movement == 0)
        put_mini_image_to_window(new_image, &data->imgs->pl_idle, data->map->player.real_x, data->map->player.real_y, (c % 6) * 64);
